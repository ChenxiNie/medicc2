...
* `--copy-number-rate`: Hyper parameter for how many copy number events per cell division (overall distance matrix = MED distance matrix + (1 / copy-number-rate) * ecDNA distance matrix). Default: 0.5
